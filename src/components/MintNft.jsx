...
import bottol from '../assets/images/png/bottol.png'
        ...
        <section className='py-5 bg-black position-relative mint_nft_bg'>
            ...
            <Container>
                <Row className='align-items-center'>
                    <Col lg={6} className='d-flex justify-content-center justify-content-lg-start mb-5 mb-lg-0'>
                        <div className='d-flex align-items-end gap-2'>
                            <div data-aos="fade-up" data-aos-duration="2000">
                                <img className='width_sm_100' src={bottol} alt="bottol" />
                            </div>
                            <div data-aos="fade-down" data-aos-duration="2000">
                                <img className='width_sm_100' src={glass} alt="glass" />
                            </div>
                        </div>
                    </Col>
                    <Col lg={6}>
                        ...
                        <div className='d-flex align-items-center mb-4 pb-1 justify-content-center justify-content-lg-start'data-aos="fade-left" data-aos-duration="2000">
                            ...
                            <h2 className='  counter_box ff_montserrat fs_lg fw-900 text_ffffff me-2 mb-0 width_sm_100'>0{plus}</h2>
