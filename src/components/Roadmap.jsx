...
import roadmap_kong from '../assets/images/png/roadmap_kong.png'
import roadmap_line from '../assets/images/png/roadmap_line.png'
        ...
        <Row className=' align-items-center'>
          ...
          <Col lg={8}>
            <div className='ms-lg-4 ps-lg-3'>
              <div className='d-flex align-items-center mb-4 pb-3 position-relative flex-sm-row flex-column roadmap'>
              ...
              <div className=' d-flex align-items-center mb-4 pb-3 ms-lg-5 ps-lg-2 position-relative flex-sm-row flex-column roadmap'>
              ...
              <div className=' d-flex align-items-center mb-4 pb-3 ms-lg-5 ps-lg-5 position-relative flex-sm-row flex-column roadmap'>
              ...
              <div className=' d-flex align-items-center position-relative flex-sm-row flex-column roadmap'>
